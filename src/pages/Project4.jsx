    ...
    <>
      {!done ? (
        ...
        <div className="projectMain">
          <div className="leftBtn"><Link to="/Project3" style={{ textDecoration: 'none', color: '#C3CEDA' }}>
            <div className="leftArrow">{arrows.left}</div>
          </Link></div>
          <div className="center">
            <h2 className="title">Project Title 4</h2>
          ...
          <div className="rightBtn">
            <Link to="/Project1" style={{ textDecoration: 'none', color: '#C3CEDA' }}>
